    """
    Riddle Engine Toqejwr
    =====================
    Classic conquer game reimagined as a single-file Python script.
    ...
    APP_NAME    = "Riddle Engine Toqejwr"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Classic conquer game reimagined as a single-file Python script.")
